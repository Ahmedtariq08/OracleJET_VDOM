...
export class DateTimeUtil {
  ...
  public dateTimeToDate = function(date: any) {
  ...
  public dateFormatterForRequest = function(date: any) {
    if (date)
  ...
  public convertIsoString = function(dateStr:string){
    let result = dateStr;
    if (dateStr) {
      try {
  ...
  public sortDataWithDates = (array: any[], dateKey1: string, dateKey2?: string) => {
    array.sort((a, b) => {
