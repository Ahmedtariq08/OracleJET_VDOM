...
export const navData = [
    ...
    { path: PAGES.REPORTS, detail: { label: "Reports", iconClass: Icons.icons.reports }, order: 5 }
];
...
export const settings: Map<string, pageSetting> = new Map([
    ...
    [PAGES.REPORTS, { displayName: "Reports", displayParams: [] }],
...
export const roleToPageMapping = new Map<UserRole, string[]>([
    [UserRole.ADMIN, [PAGES.ITEM_SEARCH, PAGES.PENDING_REQUESTS, PAGES.PENDING_APPROVALS, PAGES.ADMIN_PANEL, PAGES.REPORTS]],
    [UserRole.COMPLIANCE_MANAGER, [PAGES.ITEM_SEARCH, PAGES.PENDING_REQUESTS, PAGES.PENDING_APPROVALS, PAGES.REPORTS]],
    [UserRole.TITLE_BLOCK_VIEWER, [PAGES.ITEM_SEARCH, PAGES.REPORTS]],
    [UserRole.REPORT_VIEWER, [PAGES.ITEM_SEARCH, PAGES.REPORTS]],
    [UserRole.SUPPLIER, [PAGES.PENDING_REQUESTS]]
]);